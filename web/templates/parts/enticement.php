<section class="enticements">
	...
	<ul class="jobs-list">
		...
		<li>
			<span class="icon"></span>
			<h4>Bathrooms</h4>
			<p>Does your bathroom need a makeover? Are you looking at renovating your tub, shower, or sink? We've helped homeowners and condo goers all over DFW get their bathrooms in order! We can help you too!</p>
		</li>
		<li>
			<span class="icon"></span>
			<h4>Slabs</h4>
		...
		<li>
			<span class="icon"></span>
			<h4>Tile Floors</h4>
			<p>Looking at installing tile on your floors? It's a hard process that take a good eye and and lots of math to workout the best way forward. We've installed many tile floors for homeowners in DFW and we can help you.</p>
		</li>
		<li>
			<span class="icon"></span>
			<h4>Walkways</h4>
			<p>Looking to add a walkway to your yard to give it that clean touch and keep people from walking through your grass? We can help with custom and special tiles or patterns. We've installed many walkways for homeowners all around DFW and we can help you!</p>
		</li>
		<li>
			<span class="icon"></span>
			<h4>Wood Floors</h4>
